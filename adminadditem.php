    ...
    <body>   
        ...
        <div class="container">
            ...
            if (isset($_GET['success'])) {
                ?>
                <div class="alert alert-success" role="alert" style="margin-top: 10px"><strong>Prece ir veiksmīgi pievienota</strong></div>
                <?php
            }
            ?>   
            <!-- Filter Get-queries -->
            ...
            <form action="<?=$_SERVER['SCRIPT_NAME']?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <label for="item[discount_price]">Akcijas cena</label>
                    </div>
                    <div class="col-sm-8">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <select type="text" name="item[is_visible]">
                          ...
                          <option value="yes" <?php if (!empty($_GET['p'][13]) && $_GET['p'][13] == 'yes') echo "selected"; ?>>Jā</option>
                        </select>
                    </div>
                </div>

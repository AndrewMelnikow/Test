...
class AddDepartment
{
    private $dep_name, $dep_visible, $file_path, $file_name, $file_type, $file_errorcode, $input_error;
    ...
    public function __construct($dep_name, $dep_visible, $file)
    {
        ...
        $this->dep_visible = filter_var(stripslashes($dep_visible),FILTER_SANITIZE_FULL_SPECIAL_CHARS);
